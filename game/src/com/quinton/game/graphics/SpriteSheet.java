...
//sheet with all sprites
public class SpriteSheet {

	//path to spritesheet
	private String path;
	public final int SIZE, SPRITE_WIDTH, SPRITE_HEIGHT; // height and width of each sprite
	public int[] pixels;
	private int width, height; // height and width of spritesheet
	...
	// extract spritesheet from spritesheet
	...
	private void load() {
		...
		try {
			...
			//where we start scanning, width, height, where pixels are stored, where we start scanning, scanning size horizontally
